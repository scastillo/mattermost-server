...
// PendingAutoAddChannelMembers provides a mock function with given fields: ctx, since, hints
func (_m *LayeredStoreDatabaseLayer) PendingAutoAddChannelMembers(ctx context.Context, since int64, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	_va := make([]interface{}, len(hints))
	for _i := range hints {
		_va[_i] = hints[_i]
	}
...
// PendingAutoAddTeamMembers provides a mock function with given fields: ctx, since, hints
func (_m *LayeredStoreDatabaseLayer) PendingAutoAddTeamMembers(ctx context.Context, since int64, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	_va := make([]interface{}, len(hints))
	for _i := range hints {
		_va[_i] = hints[_i]
	}
...
// PendingChannelMemberRemovals provides a mock function with given fields: ctx, hints
func (_m *LayeredStoreDatabaseLayer) PendingChannelMemberRemovals(ctx context.Context, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	_va := make([]interface{}, len(hints))
	for _i := range hints {
		_va[_i] = hints[_i]
	}
...
// PendingTeamMemberRemovals provides a mock function with given fields: ctx, hints
func (_m *LayeredStoreDatabaseLayer) PendingTeamMemberRemovals(ctx context.Context, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	_va := make([]interface{}, len(hints))
	for _i := range hints {
		_va[_i] = hints[_i]
	}
