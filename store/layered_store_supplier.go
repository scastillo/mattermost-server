...
type LayeredStoreSupplier interface {
	...
	PendingAutoAddTeamMembers(ctx context.Context, since int64, hints ...LayeredStoreHint) *LayeredStoreSupplierResult
	PendingAutoAddChannelMembers(ctx context.Context, since int64, hints ...LayeredStoreHint) *LayeredStoreSupplierResult

	PendingTeamMemberRemovals(ctx context.Context, hints ...LayeredStoreHint) *LayeredStoreSupplierResult
	PendingChannelMemberRemovals(ctx context.Context, hints ...LayeredStoreHint) *LayeredStoreSupplierResult
}
